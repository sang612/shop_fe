export const Footer = () => {
  return <div className="absolute bottom-0 w-full">
    <footer
      className="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-black dark:text-white ">
<div class="container px-6 pt-6">
    <div class="mb-6 flex justify-center space-x-2">
      ...
      <div className="w-full bg-black/5 p-4 text-center">
        © 2024 Copyright:
        <a href="https://www.instagram.com/manminus.vintage/"  target="_blank"> @manminus.vintage</a>
      </div>
    </footer>
  </div>;
};
