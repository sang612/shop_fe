...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Product List", route: "/admin/product" },
        ...
        icon: (
          ...
          >
            ...
            <circle
              ...
              strokeWidth="4"
            />
            <circle cx="34" cy="14" r="3" fill="" />
          </svg>
        ),
        label: "Category",
        route: "#",
        children: [
          { label: "Category List", route: "/admin/category" },
          { label: "Create New Category", route: "/admin/category/create" },
        ],
      },
      {
        icon: (
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <Link href="/admin">
            <Image
              ...
              priority
            />
            <h2 className="text-[#fff] font-bold">The Time vintage Watch</h2>
          </Link>
